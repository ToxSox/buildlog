...
export const EXAMPLES = {
  vehicle: {
    ...
    caption: {
      de: 'Dreiviertel-Ansicht, komplettes Auto im Bild, gleichmäßiges Licht.',
      en: 'Three-quarter view, the whole car in frame, even light.',
    },
    tips: [
      {
      ...
      {
        de: 'Kennzeichen entweder lesbar lassen oder bewusst abkleben.',
        en: 'Either leave the plate readable or cover it deliberately.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  interior: {
    ...
    caption: {
      de: 'Vom Fahrersitz Richtung Armaturenbrett – Einbaulage der Hochtöner sichtbar.',
      en: 'From the driver seat towards the dashboard – tweeter positions visible.',
    },
    tips: [
      { de: 'Sitz in normaler Hörposition lassen.', en: 'Leave the seat in its normal listening position.' },
      { de: 'A-Säulen komplett mit im Bild.', en: 'Include the A-pillars completely.' },
    ],
    svg: () =>
      wrap(`
  ...
  battery: {
    ...
    caption: {
      de: 'Batterie im eingebauten Zustand, Niederhalter/Halterung deutlich sichtbar.',
      en: 'Battery as installed, hold-down or bracket clearly visible.',
    },
    tips: [
      {
        de: 'Die Verschraubung muss erkennbar sein – eine lose Batterie kostet sofort Punkte.',
        en: 'The bolted fixing must be visible – a loose battery costs points immediately.',
      },
  ...
  fuseRuler: {
    ...
    caption: {
      de: 'Zollstock vom Pluspol bis zur Sicherung – beides im selben Bild.',
      en: 'Folding rule from the positive post to the fuse – both in the same shot.',
    },
    tips: [
      {
      ...
      {
        de: 'Sicherungswert muss auf dem Foto lesbar sein.',
        en: 'The fuse rating must be readable in the photo.',
      },
      {
        de: 'Regelwerk: innerhalb von 40 cm zum Pluspol und/oder vor der ersten Blechdurchführung.',
        en: 'Rulebook: within 40 cm of the positive post and/or before the first metal pass-through.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  routing: {
    ...
    caption: {
      de: 'Verlauf der Leitung über eine größere Strecke, Befestigungspunkte sichtbar.',
      en: 'The cable run over a longer distance, fixing points visible.',
    },
    tips: [
      {
        de: 'Strom- und Signalkabel möglichst auf getrennten Fahrzeugseiten.',
        en: 'Route power and signal cables on opposite sides of the vehicle where possible.',
      },
  ...
  grommet: {
    ...
    caption: {
      de: 'Nahaufnahme der Spritzwand-Durchführung mit Gummitülle.',
      en: 'Close-up of the firewall pass-through with its grommet.',
    },
    tips: [
      {
      ...
      {
        de: 'Ein Bild von beiden Seiten der Wand wirkt besonders überzeugend.',
        en: 'A shot from both sides of the panel is especially convincing.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  crimp: {
    ...
    caption: {
      de: 'Kabelschuh, Presshülse und Schrumpfschlauch aus der Nähe.',
      en: 'Cable lug, ferrule and heat shrink up close.',
    },
    tips: [
      {
        de: 'Der Foto-Log ist hier ein offiziell zugelassener Nachweis – nutze ihn für alles, was später verdeckt ist.',
        en: 'The photo log is an officially accepted proof here – use it for everything that ends up hidden.',
      },
      {
        de: 'Am besten zwei Bilder: offen gecrimpt und fertig geschrumpft.',
        en: 'Ideally two shots: crimped open and finished with heat shrink.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  distribution: {
    ...
    caption: {
      de: 'Verteilerblock mit allen Abgängen, Sicherungswerte lesbar.',
      en: 'Distribution block with all branches, fuse ratings readable.',
    },
    tips: [
      {
      ...
      {
        de: 'Die Fuse Size Matrix gilt ausdrücklich auch für Verteilerblöcke und Busbars.',
        en: 'The Fuse Size Matrix explicitly covers distribution blocks and busbars too.',
      },
    ],
    svg: () =>
      wrap(`
      ...
      ${[72, 100, 128]
        .map(
          (y, i) => `<path d="M210 ${y} H 300" stroke="#dc2626" stroke-width="5"/>
        <rect x="228" y="${y - 10}" width="34" height="20" rx="3" fill="#fecaca" stroke="#b91c1c"/>
        ${label(245, y + 4, `${[60, 40, 30][i]}A`)}`,
        )
        .join('')}
  ...
  ground: {
    ...
    caption: {
      de: 'Blank geschliffene Karosseriestelle, Kabelschuh verschraubt.',
      en: 'Bare sanded chassis spot, cable lug bolted down.',
    },
    tips: [
      { de: 'Das blanke Blech muss sichtbar sein.', en: 'The bare metal must be visible.' },
      {
        de: 'Kurze Masse im Plus-Querschnitt ist gute Praxis – im Rulebook steht dazu kein Wert.',
        en: 'A short ground in the positive cross-section is good practice – the rulebook gives no value for it.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  mount: {
    ...
    caption: {
      de: 'Endstufe/DSP inklusive der Schrauben, mit denen sie gehalten wird.',
      en: 'Amplifier or DSP including the screws holding it.',
    },
    tips: [
      { de: 'Klettband gilt nicht als Befestigung.', en: 'Hook-and-loop tape does not count as mounting.' },
      {
        de: 'Detailfoto einer Schraube macht es eindeutig.',
        en: 'A close-up of one screw makes it unambiguous.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  speaker: {
    ...
    caption: {
      de: 'Chassis auf dem Adapterring, Verschraubung sichtbar.',
      en: 'Driver on the adapter ring, fixings visible.',
    },
    tips: [
      {
        de: 'Adapterring und Abdichtung mitfotografieren – das ist Handwerk.',
        en: 'Photograph the adapter ring and sealing too – that is craftsmanship.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  sub: {
    ...
    caption: {
      de: 'Gehäuse im Fahrzeug, Befestigung gegen Verrutschen sichtbar.',
      en: 'Enclosure in the vehicle, securing against movement visible.',
    },
    tips: [
      {
        de: 'Spanngurte, Winkel oder Verschraubung müssen erkennbar sein.',
        en: 'Straps, brackets or bolts must be recognisable.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  overview: {
    ...
    caption: {
      de: 'Der fertige Ausbau als Übersicht, sauber ausgeleuchtet.',
      en: 'The finished build as an overview, cleanly lit.',
    },
    tips: [
      {
        de: 'Aufgeräumt fotografieren – Werkzeug und Kabelreste raus aus dem Bild.',
        en: 'Shoot it tidy – get tools and cable offcuts out of the frame.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  damping: {
    ...
    caption: {
      de: 'Zwischenschritt-Foto: Blech, Dämmmatte, Abdeckung.',
      en: 'Intermediate photo: metal, damping mat, cover.',
    },
    tips: [
      {
        de: 'Nur Zwischenschritte belegen die Arbeit – am Ende sieht man nur die Verkleidung.',
        en: 'Only intermediate steps prove the work – in the end all you see is the trim.',
      },
      {
        de: 'Anpressen/Anrollen der Matte lässt sich gut mit einem Detailfoto zeigen.',
        en: 'Rolling the mat down is easy to show with a close-up.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  custom: {
    ...
    caption: {
      de: 'CAD-Ansicht, Rohteil und verbautes Teil – am besten drei Bilder.',
      en: 'CAD view, raw part and installed part – ideally three photos.',
    },
    tips: [
      {
        de: 'Der Dreiklang CAD → Fertigung → Einbau ist die stärkste Story in jeder Mappe.',
        en: 'The trio CAD → fabrication → installation is the strongest story in any build log.',
      },
    ],
    svg: () =>
      wrap(`
  ...
  measurement: {
    ...
    caption: {
      de: 'Screenshot des Frequenzgangs mit lesbarer Achsenbeschriftung.',
      en: 'Screenshot of the frequency response with readable axis labels.',
    },
    tips: [
      {
        de: 'Vorher/Nachher nebeneinander ist besonders aussagekräftig.',
        en: 'Before and after side by side is especially telling.',
      },
    ],
    svg: () =>
      wrap(`
